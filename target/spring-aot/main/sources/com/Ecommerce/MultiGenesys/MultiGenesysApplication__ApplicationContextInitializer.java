 ...
 */
@Generated
public class MultiGenesysApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new MultiGenesysApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new MultiGenesysApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
  ...
  private void addImportAwareBeanPostProcessors(DefaultListableBeanFactory beanFactory) {
    ...
    mappings.put("org.springframework.security.config.annotation.web.configuration.WebSecurityConfiguration", "com.example.Ecommerce.Security.WebSecurityConfig");
