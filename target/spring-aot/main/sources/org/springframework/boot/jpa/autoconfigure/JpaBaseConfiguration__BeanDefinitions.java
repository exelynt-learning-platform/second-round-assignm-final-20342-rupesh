...
public class JpaBaseConfiguration__BeanDefinitions {
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("com.example.Ecommerce.Entity.CartItem", "com.example.Ecommerce.Entity.Order", "com.example.Ecommerce.Entity.OrderItem", "com.example.Ecommerce.Entity.Product", "com.example.Ecommerce.Entity.User");
